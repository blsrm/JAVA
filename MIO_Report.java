...
public class MIO_Report {
	...
	public static void main(String[] args) {
		...
		MIO_Report mio = new MIO_Report();
		
		mio.fieldsMapping();
		mio.executeTSReportQuery();
		mio.processExcelData("C:\\MURUGAVEL\\WORK\\MIO REPORT\\SR_Datoer.xls");
	...
	public void fieldsMapping(){
		...
		// Changes done on 21st Oct 2014
		fieldsMap.put("StartWork:", "start_work");
		fieldsMap.put("StartWorkFirstTime:", "start_work_first_time");
...
**/					
	...
	public String checkFormat(String field, String value, String request_no){
		...
		if(field.equalsIgnoreCase("sent_to_vendor") || 
				...
				field.equalsIgnoreCase("start_work")||
				field.equalsIgnoreCase("start_work_first_time")||
